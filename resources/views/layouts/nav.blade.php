        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                @auth()
                    ...
                    <li class="nav-item">
                        <a class="{{(Route::is('admin.dashboard')) ? 'active' : ''}} nav-link" aria-current="page" href="{{route('admin.dashboard')}}">Admin</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <input type="submit" name="submit" class='btn btn-secondary btn-sm' value="Logout">
                        </form>
                    </li>
                @endauth
